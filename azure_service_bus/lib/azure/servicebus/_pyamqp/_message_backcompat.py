...
class LegacyMessage(object):  # pylint: disable=too-many-instance-attributes
    def __init__(
        ...
        **kwargs: Any
        ...
        self.header: Optional[LegacyMessageHeader] = (
            LegacyMessageHeader(self._message.header)
    ...
    def get_message_encoded_size(self) -> int:
        return get_message_encoded_size(
            self._to_outgoing_amqp_message(self._message)
        )
...
class LegacyMessageProperties(
    object
):  # pylint: disable=too-many-instance-attributes
    def __init__(self, properties: "AmqpMessageProperties"):
        self.message_id: Optional[bytes] = _encode_property(
        ...
        self.content_type: Optional[bytes] = _encode_property(
            properties.content_type
        )
        self.content_encoding: Optional[bytes] = _encode_property(
            properties.content_encoding
        )
        self.absolute_expiry_time: Optional[int] = (
