...
from .action import document_action, document_load_reload_action
from .attr import (
    document_attribute,
    document_identifier,
    document_reference,
...
from .subresource import document_sub_resource
from .waiter import document_resource_waiter
