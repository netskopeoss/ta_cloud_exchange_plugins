...
from .action import ActionDocumenter
from .attr import (
    document_attribute,
    document_identifier,
    document_reference,
...
from .collection import CollectionDocumenter
from .subresource import SubResourceDocumenter
from .utils import (
...
from .waiter import WaiterResourceDocumenter
