...
class Session:
    ...
    def _create_token_resolver(self):
        return tokens.create_token_resolver(self)
    ...
    def create_client(
        ...
        if config is not None and config.signature_version is UNSIGNED:
            ...
            credentials_new = self.get_credentials()
        ...
        client_creator = client.ClientCreator(
            loader,
            endpoint_resolver,
            self.user_agent(),
            event_emitter,
        ...
        client_new = client_creator.create_client(
            service_name=service_name,
        ...
        if monitor is not None:
            monitor.register(client_new.meta.events)
        return client_new
